...
PWM_STEERING_THROTTLE = {
     ...
     "PWM_THROTTLE_SCALE": 1.0,              # used to compensate for PWM frequence differences from 60hz; NOT for increasing/limiting speed
     "PWM_THROTTLE_INVERTED": False,         # True if hardware requires an inverted PWM pulse
     "STEERING_LEFT_PWM": 495, #460          #pwm value for full left steering
     "STEERING_RIGHT_PWM": 310, #290,        #pwm value for full right steering
     "THROTTLE_FORWARD_PWM": 500, #500,      #pwm value for max forward throttle
     "THROTTLE_STOPPED_PWM": 410, #370,      #pwm value for no movement
     "THROTTLE_REVERSE_PWM": 320, #220,      #pwm value for max reverse throttle
}
